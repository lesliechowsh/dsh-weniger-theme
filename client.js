window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ':root {',
      '  --weniger-radius-s: 2px; --weniger-radius-m: 4px; --weniger-radius-chip: 3px;',
      ...
      '  --dsw-static-neutral-bluish-00: #FBFAF7; --dsw-static-neutral-bluish-50: #FAFAF7; --dsw-static-neutral-bluish-60: #F1F0EB;',
      ...
      '  --dsw-static-neutral-00: #FBFAF7; --dsw-static-neutral-50: #FAFAF7; --dsw-static-neutral-100: #F1F0EB;',
      ...
      '  --dsw-static-red-50: #F7EAE7; --dsw-static-red-100: #F7EAE7; --dsw-static-red-400: #FF7A6A; --dsw-static-red-500: #E05A45;',
      ...
      '  --dsw-alias-bg-skeleton: rgba(26, 25, 23, 0.05); --dsw-alias-bg-mask-drop: rgba(251, 250, 247, 0.72); --dsw-alias-border-l2-darkmode-thin: rgba(26, 25, 23, 0.14);',
      ...
      '  --dsw-alias-button-contrast-fill: #1A1917; --dsw-alias-button-elevated-fill: #FBFAF7;',
      '  --dsw-alias-button-floating-fill: #FBFAF7; --dsw-alias-button-floating-hover: #F1EFE9;',
      ...
      '  --dsw-alias-button-primary-hover: #3A3935; --dsw-alias-button-tool-bar-fill: rgba(59, 57, 53, 0.5); --dsw-alias-button-tool-bar-fill-invisible: rgba(38, 36, 33, 0.36); --dsw-alias-button-tool-bar-hover: rgba(59, 57, 53, 0.62); --dsw-alias-interactive-bg-active: rgba(26, 25, 23, 0.08);',
      ...
      '  --dsw-alias-markdown-code-block: #F7F6F2; --dsw-alias-markdown-code-segment-selected: #FBFAF7;',
      ...
      '  --dsw-specific-input-major: #FBFAF7; --dsw-specific-login-input: #F5F4F0; --dsw-specific-menu: #FBFAF7;',
