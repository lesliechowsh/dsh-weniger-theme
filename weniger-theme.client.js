// Weniger — "less, but better" theme for the DSH Web GUI. Dynamic Cordis plugin `rams-1`, client half.
// Deployed version: pkg-19. Edit this file first, then redeploy via cordis_define + cordis_run (update).
return {
  apply(ctx) {
    ...
    // ---------- 2. Comprehensive Braun stylesheet ----------
    ctx.effect(() => styles.insert(
      ...
      '/* ---- Static ramp: every remaining blue / bluish gray becomes warm Braun ---- */' +
      'body {' +
      '  --dsw-static-deepseek-50: #FBF3EE;' +
      '  --dsw-static-deepseek-100: #F3E2D6;' +
      '  --dsw-static-deepseek-200: #F0C4A8;' +
      '  --dsw-static-deepseek-300: #E8A87F;' +
      '  --dsw-static-deepseek-400: #F07B45;' +
      '  --dsw-static-deepseek-450: #E8541E;' +
      '  --dsw-static-deepseek-500: #E8541E;' +
      '  --dsw-static-deepseek-600: #C94814;' +
      '  --dsw-static-deepseek-700-delete: #5C4436;' +
      '  --dsw-static-deepseek-800: #3A322B;' +
      '  --dsw-static-deepseek-900: #26221E;' +
      '  --dsw-static-blue-50: #F7F6F2;' +
      '  --dsw-static-blue-50p: #F5F4F0;' +
      '  --dsw-static-blue-75: #EFEDE7;' +
      '  --dsw-static-blue-100: #E6E4DD;' +
      '  --dsw-static-blue-300: #C9C6BC;' +
      '  --dsw-static-blue-400: #A6A59C;' +
      '  --dsw-static-blue-450: #8A8981;' +
      '  --dsw-static-blue-500: #6B6A63;' +
      '  --dsw-static-blue-600: #57544B;' +
      ...
      '  --dsw-static-neutral-bluish-100: #E6E4DD;' +
      '  --dsw-static-neutral-bluish-150: #DEDCD3;' +
      '  --dsw-static-neutral-bluish-200: #D5D3CA;' +
      '  --dsw-static-neutral-bluish-250: #C9C6BC;' +
      '  --dsw-static-neutral-bluish-300: #BDBBB2;' +
      '  --dsw-static-neutral-bluish-400: #A6A59C;' +
      '  --dsw-static-neutral-bluish-500: #8A8981;' +
      '  --dsw-static-neutral-bluish-550: #77766D;' +
      '  --dsw-static-neutral-bluish-600: #6B6A63;' +
      '  --dsw-static-neutral-bluish-700: #57544B;' +
      '  --dsw-static-neutral-bluish-750: #4A4941;' +
      '  --dsw-static-neutral-bluish-800: #3A3935;' +
      '  --dsw-static-neutral-bluish-850: #2C2A26;' +
      '  --dsw-static-neutral-bluish-875: #26241F;' +
      ...
      '  --dsw-static-neutral-200: #D5D3CA;' +
      '  --dsw-static-neutral-250: #C9C6BC;' +
      '  --dsw-static-neutral-300: #BDBBB2;' +
      '  --dsw-static-neutral-400: #A6A59C;' +
      '  --dsw-static-neutral-500: #8A8981;' +
      '  --dsw-static-neutral-550: #77766D;' +
      '  --dsw-static-neutral-600: #6B6A63;' +
      '  --dsw-static-neutral-700: #57544B;' +
      '  --dsw-static-neutral-800: #3A3935;' +
      '  --dsw-static-neutral-850: #2C2A26;' +
      '  --dsw-static-neutral-900: #1E1C19;' +
      '  --dsw-static-neutral-1000: #1A1917;' +
      '  --dsw-static-amber-100: #F3E9D9;' +
      '  --dsw-static-amber-400: #D9A05B;' +
      '  --dsw-static-amber-500: #A8621F;' +
      '  --dsw-static-amber-600: #8A511A;' +
      '  --dsw-static-amber-900: #2B231A;' +
      '  --dsw-static-green-100: #E7EEE7;' +
      '  --dsw-static-green-400: #7CBB84;' +
      ...
      '  --dsw-static-red-900: #3A1F1A;' +
      '}' +
      '/* ---- Derived tokens: warm Braun neutrals, orange signal accents ---- */' +
      'body {' +
      '  --dsw-alias-bg-layer-3: #E6E4DD;' +
      ...
      '  --dsw-alias-button-ghost-active-hover: #F1F0EB;' +
      '  --dsw-alias-button-info-fill: #E8541E;' +
      ...
      '  --dsw-alias-interactive-bg-hover-solid: #ECEAE4;' +
      '  --dsw-alias-interactive-bg-hover: rgba(26, 25, 23, 0.05);' +
      '  --dsw-alias-label-caption: #A6A59C;' +
      '  --dsw-alias-label-dimmed: #D5D3CA;' +
      '  --dsw-alias-label-primary-bluish: #1A1917;' +
      '  --dsw-alias-label-primary-dimmed: #3A3935;' +
      '  --dsw-alias-label-primary-foreground: #FFFFFF;' +
      '  --dsw-alias-label-primary-inverted: #FFFFFF;' +
      '  --dsw-alias-label-tertiary: #8A8981;' +
      ...
      '  --dsw-alias-markdown-tag: #E6E4DD;' +
      '  --dsw-alias-scrollbar-bg-l1: #D9D7CF;' +
      '  --dsw-alias-scrollbar-bg-l2: #D9D7CF;' +
      '  --dsw-alias-scrollbar-hover-l1: #BDBBB2;' +
      '  --dsw-alias-scrollbar-hover-l2: #BDBBB2;' +
      '  --dsw-alias-state-business-primary: #E8541E;' +
      '  --dsw-alias-state-business-tertiary: rgba(232, 84, 30, 0.10);' +
      '  --dsw-alias-state-success-tertiary: #E7EEE7;' +
      '  --dsw-alias-state-warn-tertiary: #F3E9D9;' +
      '  --dsw-alias-toast-bg: #23221F;' +
      ...
      '  --dsw-specific-sidebar-nav-item-hover: #F1F0EB;' +
      '  --dsw-specific-tip: #F1F0EB;' +
      '  --dsw-shadow-lv1: none;' +
      '  --dsw-shadow-lv2: none;' +
      '  --dsw-shadow-lv3: none;' +
      '}' +
      'body[data-ds-dark-theme] {' +
      '  --dsw-alias-border-l2-darkmode-thin: rgba(242, 239, 232, 0.10);' +
      '  --dsw-alias-bg-layer-3: #232220;' +
      '  --dsw-alias-bg-module-platform: #26241F;' +
      '  --dsw-alias-bg-multi-select: #2C2A26;' +
      '  --dsw-alias-bg-skeleton: rgba(242, 239, 232, 0.08);' +
      '  --dsw-alias-border-l3: rgba(242, 239, 232, 0.20);' +
      '  --dsw-alias-border-l4: rgba(242, 239, 232, 0.26);' +
      '  --dsw-alias-brand-primary-new-colorprimary-new-color: #FF6B35;' +
      '  --dsw-alias-brand-text: #F2EFE8;' +
      '  --dsw-alias-button-contrast-fill: #F2EFE8;' +
      '  --dsw-alias-button-elevated-fill: #26241F;' +
      '  --dsw-alias-button-floating-fill: #232220;' +
      '  --dsw-alias-button-floating-hover: #2C2A26;' +
      '  --dsw-alias-button-ghost-active-border: #ABA89E;' +
      '  --dsw-alias-button-ghost-active-fill: #2C2A26;' +
      '  --dsw-alias-button-ghost-active-hover: #26241F;' +
      '  --dsw-alias-button-info-fill: #FF6B35;' +
      '  --dsw-alias-button-info-hover: #FF8252;' +
      '  --dsw-alias-button-primary-dimmed: #2C2A26;' +
      '  --dsw-alias-button-primary-hover: #3A3833;' +
      '  --dsw-alias-interactive-bg-active: rgba(242, 239, 232, 0.14);' +
      '  --dsw-alias-interactive-bg-hover-accent: rgba(255, 107, 53, 0.18);' +
      '  --dsw-alias-interactive-bg-hover-danger: rgba(255, 107, 94, 0.14);' +
      '  --dsw-alias-interactive-bg-hover-solid: #2C2A26;' +
      '  --dsw-alias-interactive-bg-hover: rgba(242, 239, 232, 0.08);' +
      '  --dsw-alias-label-caption: #6E6C64;' +
      '  --dsw-alias-label-dimmed: #57554E;' +
      '  --dsw-alias-label-primary-bluish: #F2EFE8;' +
      '  --dsw-alias-label-primary-dimmed: #C9C6BC;' +
      '  --dsw-alias-label-primary-foreground: #1C1A17;' +
      '  --dsw-alias-label-primary-inverted: #1C1A17;' +
      '  --dsw-alias-label-tertiary: #8F8D83;' +
      '  --dsw-alias-markdown-citation: #26241F;' +
      '  --dsw-alias-markdown-code-block-banner: #1E1C19;' +
      '  --dsw-alias-markdown-code-block: #1E1C19;' +
      '  --dsw-alias-markdown-code-segment-selected: #232220;' +
      '  --dsw-alias-markdown-code-segment-unselected: #1E1C19;' +
      '  --dsw-alias-markdown-inline-code: #26241F;' +
      '  --dsw-alias-markdown-placeholder: #26241F;' +
      '  --dsw-alias-markdown-tag: #232220;' +
      '  --dsw-alias-scrollbar-bg-l1: #57544B;' +
      '  --dsw-alias-scrollbar-bg-l2: #57544B;' +
      '  --dsw-alias-scrollbar-hover-l1: #6B675D;' +
      '  --dsw-alias-scrollbar-hover-l2: #6B675D;' +
      '  --dsw-alias-state-business-primary: #FF6B35;' +
      '  --dsw-alias-state-business-tertiary: rgba(255, 107, 53, 0.16);' +
      '  --dsw-alias-state-success-tertiary: #22302A;' +
      '  --dsw-alias-state-warn-tertiary: #33291C;' +
      '  --dsw-alias-toast-bg: #0F0E0C;' +
      '  --dsw-alias-tooltip-bg: #0F0E0C;' +
      '  --dsw-specific-bubble-highlight: rgba(255, 107, 53, 0.22);' +
      '  --dsw-specific-bubble: #232220;' +
      '  --dsw-specific-input-major: #232220;' +
      '  --dsw-specific-login-input: #1E1C19;' +
      '  --dsw-specific-menu: #232220;' +
      '  --dsw-specific-selector: #2C2A26;' +
      '  --dsw-specific-sidebar-nav-item-active-accent: #FF6B35;' +
      '  --dsw-specific-sidebar-nav-item-active: #2C2A26;' +
      '  --dsw-specific-sidebar-nav-item-hover: #26241F;' +
      '  --dsw-specific-tip: #26241F;' +
      '}' +
      '/* ---- Shiki syntax palette: monochrome ink with orange accents ---- */' +
      ':root {' +
      '  --shiki-token-constant: #C94814;' +
      '  --shiki-token-string: #8A511A;' +
      '  --shiki-token-comment: #A6A59C;' +
      '  --shiki-token-keyword: #57544B;' +
      '  --shiki-token-parameter: #6B6A63;' +
      '  --shiki-token-function: #1A1917;' +
      '  --shiki-token-string-expression: #8A511A;' +
      '  --shiki-token-punctuation: #8A8981;' +
      '  --shiki-token-link: #E8541E;' +
      '}' +
      'body[data-ds-dark-theme] {' +
      '  --shiki-token-constant: #FF8252;' +
      '  --shiki-token-string: #E0A84C;' +
      '  --shiki-token-comment: #6E6C64;' +
      '  --shiki-token-keyword: #C9C6BC;' +
      '  --shiki-token-parameter: #ABA89E;' +
      '  --shiki-token-function: #F2EFE8;' +
      '  --shiki-token-string-expression: #E0A84C;' +
      ...
      'button[data-rams-chip] { border: 0 !important; border-radius: 2px; background: transparent !important; -webkit-appearance: none; appearance: none; }' +
      'button[data-rams-chip]:hover { background: var(--dsw-alias-interactive-bg-hover) !important; }'
    ))

    // ---------- 3. Braun brand chip (rail-adaptive) + Ten Principles overlay ----------
    ...
    // Chip mirrors the shipped footer badge (Nqubda_badge): height 42,
    // padding 0 10px 0 8px, gap 8, 14px primary label, inherited font.
    function Chip(props) {
      const [open, setOpen] = React.useState(store.get())
      React.useEffect(() => store.subscribe(setOpen), [])
      const wide = Boolean(props.wide)
      const label = 'Weniger — less, but better'
    ...
    function Panel() {
      ...
      return React.createElement(
        'div',
        { 'data-rams-panel': '1', role: 'dialog', 'aria-label': 'Weniger — Zehn Grundsätze guter Gestaltung', style: STYLES.panel },
        ...
        React.createElement('div', { style: STYLES.foot },
    ...
    slots.inject('sidebar.footer.action', () => slots.register(
      { name: 'sidebar.footer.action', id: 'dieter-rams', order: 100, label: 'Weniger' },
      (props) => Chip(props)
    ))
    slots.inject('shell.overlay', () => slots.register(
      { name: 'shell.overlay', id: 'dieter-rams', order: 100 },
      () => Panel()
    ))
  },
}
